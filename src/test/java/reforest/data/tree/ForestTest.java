...
public class ForestTest {
    private final RFStrategyFeature strategyFeature = new RFStrategyFeatureSQRT(10);
    private final RFFeatureSizer featureSizer = new RFFeatureSizerSimple(32, 2, new RFCategoryInfoEmpty());
    private final ForestIncremental<Double, Integer> fIncremental = new ForestIncremental<>(5, 10, 32, strategyFeature, featureSizer);
    private final ForestFull<Double, Integer> fFull = new ForestFull<>(5, 10, 32, strategyFeature, featureSizer);
    ...
    @Test
    public void merge() {
        ForestIncremental<Double, Integer> fIncremental2 = new ForestIncremental<>(5, 10, 32, strategyFeature, featureSizer);
        ForestFull<Double, Integer> fFull2 = new ForestFull<>(5, 10, 32, strategyFeature, featureSizer);
        ...
        Tree<Double, Integer> tree = new TreeFull(10);
